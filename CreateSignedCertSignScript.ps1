...
# get certificate info (VA)
$codeCertificate = Get-ChildItem Cert:\LocalMachine\My | Where-Object {$_.Subject -eq "CN=ATA Authenticode"} # gets all ATA Authenticode signed certs
$certExpirationObj = $null

# get cert's date of creation
